...
export default function TermsAndPrivacy() {
    return (
        <div className="terms-container">
            ...
            <p>
                ברוכים הבאים לאתר <strong>Online Learning</strong>.
            ...
            <p>
                📧 <strong>דוא"ל:</strong> <a href="mailto:onlinelearning374@gmail.com">onlinelearning374@gmail.com</a><br />
                📞 <strong>טלפון:</strong> 052-6650754<br />
                🏢 <strong>כתובת:</strong> הרב יצחק נסים 112, אשקלון, ישראל
            </p>

            <h2>📌 עדכון אחרון</h2>
            <p><strong>פברואר 2025</strong></p>
        </div>
    );
}
